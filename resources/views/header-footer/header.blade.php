<header class="bg-white shadow-md">
    <div class="container mx-auto flex justify-between items-center px-4 sm:px-6 lg:px-8 py-3">
        ...
        <div class="flex items-center">
            <h1 class="text-red-700 text-xl font-bold">MediaExplant</h1>
        </div>
            ...
            <div class="flex flex-col space-y-4 mt-10">
                <a href="{{ route('home') }}" class="text-gray-700 hover:text-[#990505] font-semibold">Beranda</a>
                 ...
                 <div class="group">
                    ...
                    <ul class="hidden group-hover:block mt-2 pl-4 space-y-2">
                        <li><a href="{{ route('create-news') }}" class="text-gray-600 hover:text-[#990505]">Buat Berita</a></li>
                        <li><a href="{{ route('create-product') }}" class="text-gray-600 hover:text-[#990505]">Tambahkan Produk</a></li>
                        <li><a href="{{ route('creation') }}" class="text-gray-600 hover:text-[#990505]">Tambahkan Karya</a></li>
                    </ul>
                </div>
                ...
                <div class="group">
                    ...
                    <ul class="hidden group-hover:block mt-2 pl-4 space-y-2">
                        ...
                        <li><a href="{{ route('settings') }}" class="text-gray-600 hover:text-[#990505]">Pengaturan</a></li>
                ...
                <div class="group">
                    ...
                    <ul class="hidden group-hover:block mt-2 pl-4 space-y-2">
                        ...
                        <li><a href="{{ route('wawancara') }}" class="text-gray-600 hover:text-[#990505]">Wawancara</a></li>
                ...
                <div class="group">
                    ...
                    <ul class="hidden group-hover:block mt-2 pl-4 space-y-2">
                        ...
                        <li><a href="{{ route('fotografi') }}" class="text-gray-600 hover:text-[#990505]">Fotografi</a></li>
