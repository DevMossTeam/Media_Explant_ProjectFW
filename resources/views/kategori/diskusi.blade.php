        ...
        @if ($articles->count() > 0)
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div class="lg:col-span-2 bg-white shadow rounded-lg overflow-hidden">
                    <a href="{{ route('diskusi.detail', ['a' => $articles->first()->id]) }}">
                    ...
                    <div class="p-4">
                        ...
                        <a href="{{ route('diskusi.detail', ['a' => $articles->first()->id]) }}" class="text-red-600 font-bold mt-4 inline-block">Baca Selengkapnya</a>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    @foreach ($articles->skip(1)->take(4) as $article)
                        <div class="bg-white shadow rounded-lg overflow-hidden">
                            <a href="{{ route('diskusi.detail', ['a' => $article->id]) }}">
