            ...
            <div class="md:col-span-1">
                ...
                <div class="grid grid-cols-2 gap-3">
                    @foreach ($terbaru as $item)
                        <div>
                            <a href="{{ route('kesenian-hiburan.detail', ['a' => $item->id]) }}">
                                <img src="{{ $item->first_image }}" alt="{{ $item->judul }}"
                                    class="w-full h-28 object-cover mb-1 rounded">
                            </a>
                            <a href="{{ route('kesenian-hiburan.detail', ['a' => $item->id]) }}">
                            ...
                            <div
                                ...
                                <div class="flex gap-2 text-xs">
                                    ...
                                    <button class="flex items-center gap-1 openShareModal"
                                        data-url="{{ route('kesenian-hiburan.detail', ['a' => $item->id]) }}">
            ...
            <div class="md:col-span-2 -mt-2">
                ...
                <div class="md:col-span-1">
                    ...
                    <div class="flex flex-col gap-6 mb-6">
                        @foreach ($terpopuler_kesenian as $item)
                    ...
                    <div class="md:col-span-1">
                        ...
                        <div class="flex flex-col gap-6">
                            @foreach ($terpopuler_hiburan as $item)
                                <div class="flex gap-4">
                                    <a href="{{ route('kesenian-hiburan.detail', ['a' => $item->id]) }}">
                                        <div class="w-48 h-32 overflow-hidden rounded">
                                            <img src="{{ $item->first_image }}" alt="{{ $item->judul }}"
