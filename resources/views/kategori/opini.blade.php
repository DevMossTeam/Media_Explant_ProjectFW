        ...
        @if ($articles->count() > 0)
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 bg-white shadow rounded-lg overflow-hidden">
                    <a href="{{ route('article.detail', ['id' => $articles->first()->id]) }}">
                    ...
                    <div class="p-4">
                        ...
                        <a href="{{ route('article.detail', ['id' => $articles->first()->id]) }}" class="text-red-600 font-bold mt-4 inline-block">Baca Selengkapnya</a>
                    </div>
                </div>
