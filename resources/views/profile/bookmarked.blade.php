...
@section('content')
    <div class="max-w-[1320px] mx-auto px-4 sm:px-6 py-10">
        <h1 class="text-2xl font-semibold mb-1">Bookmark</h1>
        <p class="text-sm text-gray-500 mb-4">Kumpulan Karya Yang Kamu Simpan</p>
