    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white shadow-lg rounded-lg p-6">
            ...
            <form id="productForm" action="{{ route('produk.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="judul" required class="w-full p-2 border rounded-lg focus:ring-2 focus:ring-blue-500">
                </div>

                <!-- Deskripsi -->
                <div class="mb-4">
                    <label class="block text-gray-700 font-bold mb-1">Deskripsi</label>
                    <textarea name="deskripsi" required class="w-full p-2 border rounded-lg focus:ring-2 focus:ring-blue-500"></textarea>
                </div>
        ...
        <div class="bg-white shadow-lg rounded-lg p-6">
            ...
            <div class="mb-4">
                ...
                <p class="text-gray-500 text-sm mb-1">Atur visibilitas agar dapat dilihat oleh kelompok yang diinginkan.</p>
            ...
            <div class="flex justify-between">
                <button type="button" class="bg-gray-600 text-white py-2 px-4 rounded-md hover:bg-gray-700 transition flex items-center">
                    👁️ Pratinjau
                </button>
