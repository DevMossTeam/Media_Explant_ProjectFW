...
<main class="py-8">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white shadow-md rounded-lg p-6">
            <h1 class="text-3xl font-bold text-gray-800 mb-4 text-center">Buat Produk</h1>
            <p class="text-gray-600 text-sm mb-4 text-center">Tambahkan produk baru untuk dipublikasikan.</p>

            <!-- Form Pembuatan Produk -->
            <form action="#" method="POST">
                @csrf
                <div class="mb-4">
                    <label for="judul" class="block text-gray-700 font-medium">Judul Produk</label>
                    <input type="text" id="judul" name="judul"
                        class="mt-1 p-2 w-full border rounded-md focus:ring focus:ring-red-300">
                </div>

                <div class="mb-4">
                    <label for="deskripsi" class="block text-gray-700 font-medium">Deskripsi Produk</label>
