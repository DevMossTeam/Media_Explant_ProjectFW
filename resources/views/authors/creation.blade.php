    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row gap-6">
        ...
        <div class="flex-1 bg-white shadow-md rounded-lg p-6">
            ...
            <form id="karyaForm" action="{{ route('karya.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <div id="drop-area" class="border-dashed border-2 border-gray-400 p-6 rounded-md flex flex-col items-center justify-center text-center cursor-pointer relative">
                        <input type="file" id="media" name="media" accept="image/jpeg,image/png" class="hidden" required>

                        <!-- Ikon Unggah -->
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 text-gray-500 mb-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M4 12l8-8 8 8"></path>
                            <path d="M12 20V4"></path>
                        </svg>

                        <p class="text-gray-600 text-sm">Seret dan jatuhkan file di sini atau klik untuk unggah<br><span class="text-xs">JPG, PNG (maks. 10MB)</span></p>

                        <!-- Preview Gambar -->
                        <div id="preview-container" class="hidden mt-3 relative">
                            <img id="imagePreview" class="w-48 h-auto rounded-md shadow-md" />
                            <button id="removePreview" type="button" class="absolute top-0 right-0 bg-red-500 text-white rounded-full px-2 py-1 text-sm">X</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="penulis" name="penulis" class="mt-1 p-2 w-full border rounded-md focus:ring focus:ring-blue-300" placeholder="Masukkan nama penulis..." required>
                </div>
        </div>
        ...
        <div class="w-full lg:w-1/3 bg-white shadow-md rounded-lg p-6">
            ...
            <div class="mb-4">
                ...
                <select id="kategori" name="kategori" class="mt-1 p-2 w-full border rounded-md focus:ring focus:ring-blue-300" required>
            ...
            <div class="mb-4">
                ...
                <p class="text-gray-500 text-sm mb-2">Atur visibilitas agar dapat dilihat oleh kelompok yang diinginkan.</p>
            ...
            <div class="flex items-center justify-between">
                ...
                <button type="submit" id="publishBtn" class="bg-red-600 text-white py-2 px-4 rounded-md hover:bg-red-700 transition">
                    + Publikasikan
                </button>
            </div>
        </div>
