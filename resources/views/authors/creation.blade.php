                ...
                <div class="flex-1 bg-white shadow-md rounded-lg p-6">
                    ...
                    <form action="{{ route('karya.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div id="konten-container" class="mb-4">
                            <label for="konten" id="konten-label" class="block text-gray-700 font-medium">Konten
                                Karya</label>
                        ...
                        <div class="mb-4">
                            ...
                            <div id="drop-area"
                                ...
                                <p class="text-sm text-gray-600 mt-2">Seret dan jatuhkan file di sini atau klik untuk unggah
                                </p>
