        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-12 gap-4">
                @foreach ($newsList as $index => $item)
                    @php
                        $isHeadline = $index <= 2; // Menjadikan 3 berita pertama sebagai headline
                        $isSecondRow = $index >= 3;
                    @endphp
    ...
    <section class="mt-12 mb-12">
        <div class="max-w-7xl mx-auto px-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-6">
                    ...
                    <div class="flex flex-col items-start">
                        <a href="{{ route('karya.desain-grafis.read', ['k' => $desainGrafis->id]) }}">
                            <img src="data:image/jpeg;base64,{{ $desainGrafis->media }}"
                                alt="{{ $desainGrafis->judul }}" class="w-full h-64 object-cover rounded-lg shadow-md" />
                        </a>
                ...
                @if ($desainGrafisList->count() > 5)
                    <div class="col-start-5 col-span-full flex justify-end items-end w-full">
                        <a href="{{ url('/karya/desain-grafis') }}" class="text-red-700 font-semibold text-sm">Selengkapnya
                            >></a>
                    </div>
                @endif
            </div>
